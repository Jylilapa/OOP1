...
Модуль base_product.py определяет класс-родитель BaseProduct, от которого наследуется класс Product

Модуль print_mixin.py определяет класс PrintMixin, от которого также наследуется класс Product
